...
$foros = $controlador->obtenerForosPaginados($pagina_actual, $foros_por_pagina, $busqueda);
...
<body>
    ...
    <main class="main-container">
        ...
        <div class="search-bar-container">
            <form method="GET" action="ListadoForos.php" style="display: flex; flex-grow: 1; align-items: center; margin: 0; width: 100%;">
        ...
        <div class="pagination-container">
            ...
            <a href="?pagina=<?php echo $pagina_actual + 1; ?>&buscar=<?php echo urlencode($busqueda); ?>" class="btn-page <?php echo (!$hay_mas_foros) ? 'disabled' : ''; ?>">
                Siguiente
            </a>
        </div>
